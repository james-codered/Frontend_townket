  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 gradient-hero">
      <div className="card-soft w-full max-w-sm animate-fade-in">
        ...
        <h1 className="text-xl font-display font-bold">Create your business</h1>
        <p className="text-sm text-muted-foreground mt-1">Start selling to your local community</p>
        ...
        <p className="text-center text-xs text-muted-foreground mt-2">
          Looking to buy?{" "}
          <Link to="/signup/customer" className="text-foreground font-medium hover:underline">Sign up as customer</Link>
        </p>
      </div>
    </div>
  );
